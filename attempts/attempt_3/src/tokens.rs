...
//!
//! Adding a new theme later (light, high-contrast) means adding a parallel
//! `tokens_light` module and either swapping at compile time or providing
//! a render-time substitution map. The token *names* stay fixed.
